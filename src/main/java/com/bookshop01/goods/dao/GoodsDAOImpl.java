...
import com.bookshop01.goods.vo.LetterVO;
...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	@Override
	public List<LetterVO> selectLettersList() throws DataAccessException{
		List<LetterVO> imageList=(ArrayList)sqlSession.selectList("mapper.goods.selectLettersList");
